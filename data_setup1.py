...
def get_raw_data():
    ...
    course_by_cohort = {
        cohorts_map['大数据-1']: [
            Course(id="BD1_L01", name="计算机科学技术导论", course_type='theory_only', theory_hours=32, teaching_class_count=3, teacher_override={1:"T20"}),
            Course(id="BD1_L02", name="高等数学", course_type='theory_only', theory_hours=96, teaching_class_count=4, teacher_override={3:"T15", 4:"T15"}),
            Course(id="BD1_L03", name="程序设计基础（C语言）", course_type='mixed', theory_hours=32, lab_hours=16, teaching_class_count=4, teacher_override={3:"T08", 4:"T08"}),
            Course(id="BD1_L04", name="两个教师课程1", course_type='theory_only', theory_hours=32, teaching_class_count=1, phase_teachers={"phase1":(1, 8, "T22"), "phase2":(9, 16, "T23")}),
        ...
        cohorts_map['大数据-2']: [
            ...
            Course(id="BD2_L02", name="计算机组成原理", course_type='theory_only', theory_hours=56, teaching_class_count=2),
            Course(id="BD2_L03", name="数据结构", course_type='theory_only', theory_hours=64, teaching_class_count=2, teacher_override={2:"T17"}),
            Course(id="BD2_L04", name="数据结构实验", course_type='lab_only', lab_hours=32, teaching_class_count=2, teacher_override={2:"T17"}),
            Course(id="BD2_L05", name="概率论与数理统计", course_type='theory_only', theory_hours=48, teaching_class_count=2),
        ],
        cohorts_map['物联网-2']: [
            Course(id="TOT2_L01", name="离散数学", course_type='theory_only', theory_hours=48, teaching_class_count=2),
            Course(id="TOT2_L02", name="计算机组成原理", course_type='theory_only', theory_hours=56, teaching_class_count=2),
            ...
            Course(id="TOT2_L05", name="概率论与数理统计", course_type='theory_only', theory_hours=48, teaching_class_count=2),
        ],
        cohorts_map['大数据-3']: [
            Course(id="BD3_L01", name="运筹学", course_type='theory_only', theory_hours=48, teaching_class_count=1),
            Course(id="BD3_L02", name="JAVA语言程序设计", course_type='theory_only', theory_hours=32, teaching_class_count=1),
            ...
            Course(id="BD3_L05", name="软件工程", course_type='mixed', theory_hours=48, lab_hours=16,teaching_class_count=2, teacher_override={2:"T08"}),
            Course(id="BD3_L06", name="算法设计与分析", course_type='mixed', theory_hours=32, lab_hours=32, teaching_class_count=2),
        ...
        cohorts_map['大数据-4']: [
            Course(id="BD4_L01_A", name="云计算", course_type='theory_only', theory_hours=26, teaching_class_count=1, preferred_pattern='weeks_5_to_17'),
            ...
            Course(id="BD4_L02", name="人工智能", course_type='theory_only', theory_hours=48, teaching_class_count=1, preferred_pattern='weeks_5_to_16'),
            Course(id="BD4_L03_A", name="区块链技术及应用", course_type='theory_only', theory_hours=26, teaching_class_count=1, preferred_pattern='weeks_5_to_17'),
        ...
        cohorts_map['物联网-4']: [
            ...
            Course(id="TOT4_L02_A", name="区块链技术及应用", course_type='theory_only',  theory_hours=26, teaching_class_count=1, preferred_pattern='weeks_5_to_17'),
...
'''
    ...
    fixed_schedule = [
        # 大数据大一
        {'cohort_id': '大数据-1', 'group_tag': 'group_A', 'course_name': '大学英语', 'teacher_name': '英语老师','duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=2, period=7)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_B','course_name': '大学英语', 'teacher_name': '英语老师', 'duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=2, period=7)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_C', 'course_name': '大学英语', 'teacher_name': '英语老师','duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=4, period=3)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_D', 'course_name': '大学英语', 'teacher_name': '英语老师','duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=4, period=1)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_E', 'course_name': '大学英语', 'teacher_name': '英语老师','duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=2, period=7)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_F','course_name': '大学英语', 'teacher_name': '英语老师', 'duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=4, period=1)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_A', 'course_name': '习近平新时代中国特色社会主义思想概论', 'teacher_name': '政治老师', 'duration': 3,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=1, period=5)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_B', 'course_name': '习近平新时代中国特色社会主义思想概论', 'teacher_name': '政治老师', 'duration': 3,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=1, period=1)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_C', 'course_name': '习近平新时代中国特色社会主义思想概论', 'teacher_name': '政治老师', 'duration': 3,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=1, period=1)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_D', 'course_name': '习近平新时代中国特色社会主义思想概论', 'teacher_name': '政治老师', 'duration': 3,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=1, period=5)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_E', 'course_name': '习近平新时代中国特色社会主义思想概论', 'teacher_name': '政治老师', 'duration': 3,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=2, period=1)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_F', 'course_name': '习近平新时代中国特色社会主义思想概论', 'teacher_name': '政治老师', 'duration': 3,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=2, period=1)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_A', 'course_name': '大学心理健康教育', 'teacher_name': '政治老师', 'duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=2, period=3)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_B', 'course_name': '大学心理健康教育', 'teacher_name': '政治老师', 'duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=2, period=3)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_C', 'course_name': '大学心理健康教育', 'teacher_name': '政治老师', 'duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=2, period=7)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_D', 'course_name': '大学心理健康教育', 'teacher_name': '政治老师', 'duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=2, period=7)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_E', 'course_name': '大学心理健康教育', 'teacher_name': '政治老师', 'duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=3, period=3)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_F', 'course_name': '大学心理健康教育', 'teacher_name': '政治老师', 'duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=3, period=3)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_A', 'course_name': '中国近现代史纲要', 'teacher_name': '政治老师', 'duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=3, period=3)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_B', 'course_name': '中国近现代史纲要', 'teacher_name': '政治老师', 'duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=3, period=3)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_C', 'course_name': '中国近现代史纲要', 'teacher_name': '政治老师', 'duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=3, period=3)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_D', 'course_name': '中国近现代史纲要', 'teacher_name': '政治老师', 'duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=3, period=3)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_E', 'course_name': '中国近现代史纲要', 'teacher_name': '政治老师', 'duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=3, period=7)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_F', 'course_name': '中国近现代史纲要', 'teacher_name': '政治老师', 'duration': 2,
        ...
        {'cohort_id': '大数据-1', 'group_tag': 'group_A', 'course_name': '大学体育', 'teacher_name': '体育老师', 'duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=1, period=1)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_B','course_name': '大学体育', 'teacher_name': '体育老师', 'duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=5, period=7)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_C', 'course_name': '大学体育', 'teacher_name': '体育老师', 'duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=5, period=7)},
        {'cohort_id': '大数据-1', 'group_tag': 'group_D', 'course_name': '大学体育', 'teacher_name': '体育老师', 'duration': 2,
        ...
        # 大数据大二
        {'cohort_id': '大数据-2', 'group_tag': 'group_A', 'course_name': '大学英语', 'teacher_name': '英语老师', 'duration': 2,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=2, period=1)},
        ...
        {'cohort_id': '大数据-2', 'group_tag': 'group_A', 'course_name': '马克思主义基本原理', 'teacher_name': '政治老师', 'duration': 3,
         'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=2, period=5)},
        {'cohort_id': '大数据-2', 'group_tag': 'group_B', 'course_name': '马克思主义基本原理',
         'teacher_name': '政治老师', 'duration': 3, 'week': SEMESTER_WEEKS, 'start_time': TimePoint(week=None, day=2, period=1)},
